...
function cambiarColor(btn) {
  ...
  // Aplica el color a toda la página via variables CSS
  ...
  const seed = 'Jerson Martinez'; // 🔧 cambia esto por tu nombre
  document.getElementById('avatar-img').src =
    `https://api.dicebear.com/7.x/notionists/svg?seed=${encodeURIComponent(seed)}&backgroundColor=${color.replace('#', '')}`;
